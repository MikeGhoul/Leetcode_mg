...
-- @leetcode\\.com: Match the literal '@leetcode.com' which matches the domain.

-- Note we have to escape the '.' in leetcode.com with \\ or else 'leetcode?com' will also be matched

-- Note we end the regex with a '$' to note that the match must be present at the end of the string
