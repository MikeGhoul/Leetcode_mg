...
-- Pull records where tiv_2015 has more than one instance
-- Pull records where lon and lat have only one insteance
-- Group by each in the subqueries and filter where HAVING meets the criteria
